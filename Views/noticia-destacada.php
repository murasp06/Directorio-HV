...
<body style="background-color: rgba(238, 238, 238,1);">
    <main>
        ...
        <div style="background-color: #ffff;" class="container mt-1 text-center">
            ...
            <h1 style="font-family:'flatory serif'" class="display-3   border-bottom border-danger border-3 text-center"><img style="border-radius: 50px 0px 45px 50px;" src="../image/WhatsApp Image 2023-10-01 at 5.45.47 PM.jpeg" width="65" height="65" alt="L.amfica">Noticias!</h1>
            <?php
